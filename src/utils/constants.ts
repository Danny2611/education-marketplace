...
export const CHAT_RESPONSES = {
  greeting: 'Xin chào! Tôi là trợ lý AI. Tôi có thể giúp bạn tìm khoá học phù hợp. Bạn muốn học gì?',
  error: 'Xin lỗi, tôi không thể hiểu câu hỏi của bạn. Bạn có thể nói rõ hơn được không?',
  noResults: 'Tôi không tìm thấy khoá học phù hợp. Bạn có thể thử từ khóa khác không?'
};
