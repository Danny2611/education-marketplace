        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mb-4 text-gray-600">
              Nền tảng học tập trực tuyến hàng đầu với hàng ngàn khóa học chất
              lượng cao từ các chuyên gia trong ngành.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              ...
              <li>
                <a href="#" className="transition-colors hover:text-blue-500">
                  <Link to="/whist-list">Mục yêu thích</Link>
                </a>
              </li>
              <li>
                <a href="#" className="transition-colors hover:text-blue-500">
                  <Link to="/history-view">Lịch sử</Link>
                </a>
              </li>
            </ul>
          </div>
          ...
          {/* Support */}
          <div>
            <h4 className="mb-4 text-lg font-semibold text-gray-900">Hỗ trợ</h4>
            <ul className="space-y-2 text-gray-600">
              <li>
                <a href="#" className="transition-colors hover:text-blue-500">
                  Trung tâm trợ giúp
